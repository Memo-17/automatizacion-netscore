...
import { config } from '../config/env.config.js';
  ...
  test('Flujo completo de calificación NL_PEX_ST', async ({ page }) => {
    ...
    await page.getByRole('option', { name: 'NETLIFE - Proveedor Externo - Cobranzas', exact: true }).click();
    console.log('Seleccionado el módulo NETLIFE - Proveedor Externo - Cobranzas');
