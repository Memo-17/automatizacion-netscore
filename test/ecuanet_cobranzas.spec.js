...
import { config } from '../config/env.config.js';
  ...
  test('Flujo completo de calificación EC_COBRANZAS', async ({ page }) => {
    ...
    await page.getByRole('option', { name: 'ECUANET - COBRANZAS' }).click();
    console.log('Seleccionado el módulo ECUANET - COBRANZAS');
    await page.locator('p-dropdown').filter({ hasText: 'Buscar agente' }).getByLabel('dropdown trigger').click();
    await page.getByRole('option', { name: 'Lata Escalante Darwin' }).locator('div').first().click();
