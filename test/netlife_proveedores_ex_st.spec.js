...
import { config } from '../config/env.config.js';
  ...
  test('Flujo completo de calificación NL_PEX_ST', async ({ page }) => {
    ...
    await page.getByRole('option', { name: 'NETLIFE - Proveedores Externos - Soporte Técnico', exact: true }).click();
    console.log('Seleccionado el módulo NETLIFE - Proveedores Externos - Soporte Técnico');
    ...
    await page.getByRole('option', { name: 'No name' }).locator('div').first().click();
