...
import { config } from '../config/env.config.js';
  ...
  test('Flujo completo de calificación NL_CX', async ({ page }) => {
    ...
    await page.getByRole('option', { name: 'NETLIFE - CX' }).click();
    console.log('Seleccionado el módulo NETLIFE - CX');
    await page.locator('p-dropdown').filter({ hasText: 'Buscar agente' }).getByLabel('dropdown trigger').click();
    await page.getByRole('option', { name: 'Espinosa Cevallos Gabriela' }).locator('div').first().click();
