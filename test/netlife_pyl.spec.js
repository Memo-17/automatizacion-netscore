...
import { config } from '../config/env.config.js';
  ...
  test('Flujo completo de calificación NL_PYL', async ({ page }) => {
    ...
    await page.getByRole('option', { name: 'NETLIFE - PYL' }).click();
    console.log('Seleccionado el módulo NETLIFE - PYL');
    await page.locator('p-dropdown').filter({ hasText: 'Buscar agente' }).getByLabel('dropdown trigger').click();
    await page.getByRole('option', { name: 'Guala Fonseca Jefferson' }).locator('div').first().click();
