...
import { config } from '../config/env.config.js';
  ...
  const calificationRegular = async (page) => {
    ...
    await page.locator('input.p-inputtext.p-component.p-element.ng-untouched.ng-pristine.ng-valid.p-filled.text-yellow-400').textContent();
    console.log('Calificación Regular validada con éxito');
  }
